...
public class CommentsDao {
	...
	public int insert(int contents_num,String comments_content,int users_num) { //댓글입력
		Connection con=null;  
		PreparedStatement pstmt=null;
		try {
			con=ConnectionPool.getCon();
	...
	public int update(String comments_content, int comments_num) { //댓글수정
		Connection con=null;
		PreparedStatement pstmt=null;
		try {
			con=ConnectionPool.getCon();
			...
			pstmt=con.prepareStatement(sql);
			System.out.println("댓글 update 메소드의 comments_content : "+comments_content);
