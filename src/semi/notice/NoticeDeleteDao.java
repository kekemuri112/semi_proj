...
public class NoticeDeleteDao {
	...
	public ArrayList<Integer> getContents_num(int notice_num) { //�Խ��ǿ� ���ϴ� �Խñ۳ѹ� �̾ƿ���.
		Connection con=null;
		PreparedStatement pstmt=null;
		ResultSet rs=null;
		try {
	...
	public int getNotice_lev(int notice_num) { //�Խ��� lev ���ϱ�
		Connection con=null;
		PreparedStatement pstmt=null;
		ResultSet rs=null;
		try {
	...
	public ArrayList<Integer> getNotice_num(int notice_num) { //���ѰԽ��� �Խ��ǹ�ȣ ���ϱ�.
		Connection con=null;
		PreparedStatement pstmt=null;
		ResultSet rs=null;
		try {
